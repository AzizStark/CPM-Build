...
ClientsService.ɵfac = function ClientsService_Factory(t) { return new (t || ClientsService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"])); };
...
/*!******************************************!*\
  !*** ./src/app/core/utils/validation.ts ***!
  \******************************************/
/*! exports provided: ProjectValidation */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
const ProjectValidation = (project) => {
    ...
    if (project.about.trim().split(' ').length < 10) {
        errors.about = 'Project description should have minimum 10 words';
        isValid = false;
    }
