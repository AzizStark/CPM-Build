(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~main-clients-clients-module~main-projects-projects-module~main-resources-resources-module~ma~9b4ca8e5"],{
...
class PaginationService {
    constructor() {
        this.resourcesPageState = { id: 'resource-pagination', pageNumber: 1, itemsCount: 10, sortOptions: 'All', activeOptions: 'All' };
        this.skillsPageState = { id: 'skill-pagination', pageNumber: 1, itemsCount: 10, sortOptions: 'Skill Name', activeOptions: 'Organisational' };
        this.projectPageState = { id: 'project-pagination', pageNumber: 1, itemsCount: 10, sortOptions: 'Project Name', activeOptions: 'All' };
        this.clientPageState = { id: 'client-pagination', pageNumber: 1, itemsCount: 10, sortOptions: 'Client Name', activeOptions: 'Active' };
        this.changeResourcesPageState = new rxjs__WEBPACK_IMPORTED_MODULE_1__["Subject"]();
        this.changeSkillsPageState = new rxjs__WEBPACK_IMPORTED_MODULE_1__["Subject"]();
        this.changeProjectsPageState = new rxjs__WEBPACK_IMPORTED_MODULE_1__["Subject"]();
        this.changeClientsPageState = new rxjs__WEBPACK_IMPORTED_MODULE_1__["Subject"]();
        this.setResourcesPageState = (value) => {
            this.changeResourcesPageState.next(value);
        };
        this.setSkillsPageState = (value) => {
            this.changeSkillsPageState.next(value);
        };
        this.setProjectsPageState = (value) => {
            this.changeProjectsPageState.next(value);
        };
        this.setClientsPageState = (value) => {
            this.changeClientsPageState.next(value);
        };
        this.changeResourcesPageState.subscribe((value) => {
            this.resourcesPageState = value;
        });
        this.changeSkillsPageState.subscribe((value) => {
            this.skillsPageState = value;
        });
        this.changeProjectsPageState.subscribe((value) => {
            this.projectPageState = value;
        });
        this.changeClientsPageState.subscribe((value) => {
            this.clientPageState = value;
        });
    }
}
PaginationService.ɵfac = function PaginationService_Factory(t) { return new (t || PaginationService)(); };
...
//# sourceMappingURL=default~main-clients-clients-module~main-projects-projects-module~main-resources-resources-module~ma~9b4ca8e5.js.map