(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~main-clients-clients-module~main-projects-projects-module~main-skills-skills-module"],{
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/ngx-chips/node_modules/tslib/tslib.es6.js");
...
class SkillsService {
    constructor(httpClient) {
        ...
        this.updateSkill = (skill) => {
            return this.httpClient.patch(`${this.getUrl()}`, skill);
        };
        this.removeSkill = (id) => {
...
/***/ "./src/app/core/utils/queryUtils.ts":
/*!******************************************!*\
  !*** ./src/app/core/utils/queryUtils.ts ***!
  \******************************************/
/*! exports provided: convertToSortQueryString, convertToActiveQueryString */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "convertToSortQueryString", function() { return convertToSortQueryString; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "convertToActiveQueryString", function() { return convertToActiveQueryString; });
/**
 * @description This function converts sort option to proper query strings that server demands
 * @param option the sort option
 * @returns queryString Proper query string
 */
const convertToSortQueryString = (option) => {
    switch (option) {
        case 'Project ID': return 'id';
        case 'Client ID': return 'id';
        case 'Skill ID': return 'id';
        case 'Skill Name': return 'name';
        case 'Project Name': return 'name';
        case 'Client Name': return 'name';
        case 'Start Date': return 'createdat';
        default: return option;
    }
};
/**
 * @description This function converts active option to proper query strings that server demands
 * @param option the active option
 * @returns queryString Proper query string
 */
const convertToActiveQueryString = (option) => {
    switch (option) {
        case 'All': return 'all';
        case 'Active': return 'true';
        case 'Inactive': return 'false';
        case 'Organisational': return 'true';
...
//# sourceMappingURL=default~main-clients-clients-module~main-projects-projects-module~main-skills-skills-module.js.map